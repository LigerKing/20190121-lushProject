        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="page-scroll">
                       <!--  <a href="#portfolio">Products</a> -->
                        ...
                        <ul class="drop-down">
                           ...
                           <li><a href="product/product_BODY.jsp">BODY</a></li>
                           <li><a href="product/product_FACE.jsp">FACE</a></li>
                           <li><a href="product/product_HAIR.jsp">HAIR</a></li>
                           <li><a href="product/product_SHOWER.jsp">SHOWER</a></li>
                        </ul>
                    ...
                    <li class="page-scroll">
                        <a href="shop/shop_sr.jsp">Shops</a>
                    </li>
                    <li class="page-scroll">
                    ...
                    <a href=""><img src="img/top/icon_top_mypage.png"></a>
                    		<ul class="drop-down">
                    			<li><a href="top_frame.jsp">로그아웃</a></li>
